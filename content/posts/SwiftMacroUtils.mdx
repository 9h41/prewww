...
heroImg: ''
excerpt: >
  Meta programming in Java was cool and allowed to improve code.
  Swift now features macros and they can be leveraged to fill the gap left by leaving Java 
  annotations behind
author: content/authors/Cedric.md
